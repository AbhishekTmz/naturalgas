...
class PostApi {
  static Future<void> post(
    ...
    request.body = json.encode(
        "Company_Pan:$pannumber,Branch_Code:$branchnumber,BillNo:${billNumber},Bill_dateTime:${date},Product:${title},Qty:${quantity},Rate:${rate},Amount:${vat},Discount:0,Vat:13%,NetAmt:${totalPrice + x.toString()}");
